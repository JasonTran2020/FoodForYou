...
data class Recipe (val name:String,val ingredients:List<String>,val webpageUrl:String,val imageUrl:String, val dietaryCompliances:List<String>,val cuisine:String, val description:String) {
